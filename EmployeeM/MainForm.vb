...
Public Class MainForm
    ...
    Private Sub BOToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles BOToolStripMenuItem.Click
        waitopen()
        AddBOFrm.MdiParent = Me
        AddBOFrm.WindowState = FormWindowState.Normal
        AddBOFrm.Show()
        waitclose()
    End Sub
    ...
    Private Sub SOToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles SOToolStripMenuItem.Click
        waitopen()
        AddSOFrm.MdiParent = Me
        AddSOFrm.WindowState = FormWindowState.Normal
        AddSOFrm.Show()
        waitclose()
    End Sub
    ...
    Private Sub PersonalToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles PersonalToolStripMenuItem.Click
        waitopen()
        AddEmpFrm.MdiParent = Me
        AddEmpFrm.WindowState = FormWindowState.Normal
        AddEmpFrm.Show()
        waitclose()
    End Sub
    ...
    Private Sub OfficeToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles OfficeToolStripMenuItem.Click
        waitopen()
        AddEmpOffFrm.MdiParent = Me
        AddEmpOffFrm.WindowState = FormWindowState.Normal
        AddEmpOffFrm.Show()
        waitclose()
    End Sub
End Class
